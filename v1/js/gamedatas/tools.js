class Tools extends Phaser.Scene {
	...
	onResize(event) {
		console.log('resizing window', document.querySelector('canvas').width + 'px', document.querySelector('canvas').height + 'px')

		var Acanvas = document.querySelector("canvas");
		var AwindowWidth = window.innerWidth;
		var AwindowHeight = window.innerHeight;
		var AwindowRatio = AwindowWidth / AwindowHeight;
		var AgameRatio = GAME.config.width / GAME.config.height;

		if (AwindowRatio < AgameRatio) {
			Acanvas.style.width = AwindowWidth + "px";
			Acanvas.style.height = (AwindowWidth / AgameRatio) + "px";
		}
		else {
			Acanvas.style.width = (AwindowHeight * AgameRatio) + "px";
			Acanvas.style.height = AwindowHeight + "px";
		}
